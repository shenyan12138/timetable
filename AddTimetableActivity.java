package com.baisang.baisangtimetable;
...
public class AddTimetableActivity extends Activity {
    ...
    private Class returnClass = ActivityTimetable.class;
    ...
    private void initsData() {
        ...
        returnClass = BundleTools.getFromClass(this, ActivityTimetable.class);
